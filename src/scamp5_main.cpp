// ---------------------------------------------------------------------------
// Adapted from scamp5_main.cpp in
// github.com/lauriebose/Scamp5-MNIST_AREG_CNN_example -- unchanged entry-
// point boilerplate, just calls MAIN_GESTURE_SINGLE_LAYER_16() instead of
// the MNIST main function.
...
void scamp5_main() {
    ...
    vs_on_host_connect([&]() {
        vs_post_text("Scamp5d Gesture Recognition\n");
